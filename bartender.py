...
drink_nouns = ["Leviathon", "Krackin'", "White-Whale", "Moby Dick", "Sea-Leg", "Land-Lubbarrr", "Will-o-the-Wisp", "Siren",
              "Treasure Chest", "Treasure Map"]

adverbs = ["rarely", "try not to", "never", "sometimes", "don't often", "barely ever"]

similies = ["Elephant Seal", "Sperm Whale", "Tiger Shark", "Bottle Nose Dolphin", "Sea Urchin"]
...
def ask_name():
    repeat = False
    print "Ahoy! Who goes there?"
    name = raw_input()
    another = True
    if name in patrons:
        repeat = True
        print "Of course,", name, "I see you like my drinks ya ol sea-dog!"
        print "I'm like a", random.choice(similies) +"," + " I", random.choice(adverbs), "forget!"
